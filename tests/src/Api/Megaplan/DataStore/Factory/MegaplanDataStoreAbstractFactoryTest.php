...
namespace rollun\test\api\Api\Megaplan\DataStore\Factory;

use rollun\api\Api\Megaplan\DataStore\Factory\MegaplanAbstractFactory;
use rollun\datastore\DataStore\DataStoreAbstract;
use rollun\test\api\Api\Megaplan\DataStore\ContainerMockTrait;
use Zend\ServiceManager\Exception\ServiceNotFoundException;
use Zend\ServiceManager\Exception\InvalidArgumentException;

class MegaplanDataStoreAbstractFactoryTest extends \PHPUnit_Framework_TestCase
{
